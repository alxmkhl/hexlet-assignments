...
class AppTest {
    ...
    void testReversedSequence3() {
        char text = new ReversedSequence("abcdef").charAt(1);
        char result = 'e';
    ...
    void testReversedSequence4() {
        int length = new ReversedSequence("abcdef").length();
        int result = 6;
    ...
    void testReversedSequence5() {
        String subSequence = new ReversedSequence("abcdef").subSequence(1, 4).toString();
        String result = "edc";
        assertThat(subSequence).isEqualTo(result);
    }
